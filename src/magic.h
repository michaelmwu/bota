...
DECLARE_SPELL_FUN(	spell_vacillating_aura	);
...
DECLARE_SPELL_FUN(	spell_create_cloud	);
DECLARE_SPELL_FUN(	spell_accelerate_poison	);
DECLARE_SPELL_FUN(	spell_call_beast	);
DECLARE_SPELL_FUN(	spell_peace		);
