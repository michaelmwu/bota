...
/* bank account data recycling */
#define BAD BANK_ACCOUNT_DATA
BAD	*new_bank_account args( (void) );
void	free_bank_account args( (BAD *bank_account) );
#undef BAD

/* grant data recycling */
#define GD GRANT_DATA
GD	*new_grant args( (void) );
void	free_grant args( (GRANT_DATA *grant) );
#undef GD

/* quest data recycling */
#define QD QUEST_DATA
QD	*new_quest args( (void) );
void	free_quest args( (QD *quest) );
#undef QD

/* pk-count data recycling */
#define PKC PK_COUNT_DATA
PKC	*new_pk_count args( (void) );
void	free_pk_count args( (PKC *pk_count) );
#undef PKC
